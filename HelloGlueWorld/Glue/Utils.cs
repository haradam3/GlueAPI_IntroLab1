...
namespace HelloGlueWorld
{
   ...
   {
      ///===============================================================
      /// Functions to generate the signature components. 
      ...
      /// (the UNIX epoch). 
      /// The BIM 360 Glue Platform accepts timestamps up to 
      /// a configurable number of minutes on either side of the server 
      /// timestamp to accommodate reasonable clock drift
      ///
      ...
      /// 128-bit (16-byte) hash value, typically expressed as 
